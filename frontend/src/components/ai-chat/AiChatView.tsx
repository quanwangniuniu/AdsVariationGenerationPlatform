...
export default function AiChatView({ workspaceId }: AiChatViewProps) {
  ...
  const variantBasePath = workspaceId
    ...
    if (response?.variant?.id) {
      ...
      const interval = setInterval(async () => {
        try {
          ...
          const res = await axios.get(`${variantBasePath}/${variantId}/`, {
            headers: appendAuthHeaders({ Authorization: `Token ${token}` }),
          });
          const data = res.data;
          setVariant(data);
  ...
  return (
    <>
      ...
      <main className="flex h-screen">
        {/* left side */}
        <aside className="bg-gray-50 border-r p-4">
            ...
            <div className="variant-wrap">
              <div className="variant-row">
                ...
                <div className="variant-details">
                  ...
                  <button className="like-btn">Like This ♥</button>
      ...
      <style jsx>{`
        ...
        .history-btn {
          ...
          padding: 10px 16px;
          font-weight: 600;
          box-shadow: 0 10px 24px rgba(249, 168, 212, 0.25);
